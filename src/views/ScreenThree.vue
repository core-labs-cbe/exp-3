...
<template>
    <main>
        ...
        <div style="padding: 30px;">
            <header>
                <h1>Step 3: Completing the Class Diagram</h1>
                <p>Now that methods and attributes have been identified and
                    grouped, we need to identify the reltionship between the
                    classes, followed by the multiplicity to complete the class
                    diagram.</p>
            </header>
